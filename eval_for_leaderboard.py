...
parser.add_argument(
    '-params',
    dest='params',
    default='models/multiatt/default_two_opt.json',
...
parser.add_argument(
    '-answer_ckpt',
    dest='answer_ckpt',
    default='results/answer_save_m2_2_withbceloss_two_opt_noam_711/best.th',
...
parser.add_argument(
    '-rationale_ckpt',
    dest='rationale_ckpt',
    default='results/reason_save_full_g21_layer4_727/best.th',
